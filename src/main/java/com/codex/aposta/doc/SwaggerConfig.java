...
public class SwaggerConfig {
    ...
    private ApiInfoBuilder informacoesApi() {
        ...
        apiInfoBuilder.title("Apostas - REST API");
        apiInfoBuilder.description("Api para Apostas");
    ...
    public Docket detalheApi() {
        ...
        docket.select()
                .apis(RequestHandlerSelectors.basePackage("com.codex.aposta.controller"))
